...
const nextConfig = {
  // ── Performance: enable React strict mode & compress responses ──
  ...
  images: {
    ...
    // ── Performance: limit generated image sizes ──
    deviceSizes: [640, 750, 828, 1080, 1200],
    imageSizes: [16, 32, 48, 64, 96, 128, 256],
    // ── Performance: reduce quality slightly for speed ──
    ...
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'electronicspanga.com',
      },
      {
        protocol: 'https',
        hostname: 'www.electronicspanga.com',
      },
      {
        protocol: 'https',
...
export default withSentryConfig(nextConfig, {
  ...
  // Automatically annotate React components to show their full name in breadcrumbs and section listings
