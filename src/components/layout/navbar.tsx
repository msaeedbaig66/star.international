...
export async function Navbar() {
 ...
 return (
 <header className="relative z-[100] transition-all">
 {/* ── Tier 1: Premium Utility Bar ── */}
 <div className="bg-slate-50/90 backdrop-blur-md border-b border-slate-200/40 py-1.5 hidden sm:block">
 <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
 <div className="flex items-center gap-6">
 <div className="flex items-center gap-1.5">
 <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
 <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Platform Status: Active</span>
 </div>
 ...
 <Link href="/help" className="text-[10px] font-black text-slate-400 hover:text-emerald-600 uppercase tracking-widest transition-colors">Support</Link>
 <Link href="/contact" className="text-[10px] font-black text-slate-400 hover:text-emerald-600 uppercase tracking-widest transition-colors">Contact</Link>
 </div>
 </div>
 </div>

 {/* ── Tier 2: Main Navigation Unit ── */}
 <div className="premium-glass bg-white/90">
 ...
 <div className="hidden lg:flex items-center gap-1 border-r border-slate-100 pr-4 mr-1 opacity-0 pointer-events-none" />
 ...
 <nav className="flex items-center p-1.5 bg-slate-100/50 rounded-2xl border border-slate-200/50 shadow-inner">
 {[
 ...
 key={idx}
 href={link.href} 
 className="px-3 sm:px-6 py-2 rounded-xl text-[10px] sm:text-[11px] font-black uppercase tracking-widest text-slate-500 hover:text-emerald-600 hover:bg-white transition-all flex items-center gap-2 whitespace-nowrap group/nav"
 >
 <span className="opacity-0 group-hover/nav:opacity-100 transition-opacity text-emerald-500">•</span>
 {link.label}
 {link.status === 'live' && (
 <span className="bg-emerald-100 text-emerald-700 text-[8px] font-black px-2 py-0.5 rounded-md border border-emerald-200/50 uppercase tracking-widest">
 Live
 </span>
 )}
 </Link>
