...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-6">
      <div className="w-full max-w-[520px] bg-white dark:bg-slate-900 rounded-3xl shadow-2xl p-10 border border-primary/5 animate-in fade-in zoom-in-95 duration-500">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight mb-2">Final Step!</h1>
          <p className="text-slate-500 dark:text-slate-400 font-medium">Please select your University details to continue.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select
              required
              className="w-full h-14 px-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 focus:ring-4 focus:ring-primary/10 outline-none transition-all font-bold appearance-none"
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full h-14 px-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 focus:ring-4 focus:ring-primary/10 outline-none transition-all font-bold appearance-none disabled:opacity-50"
