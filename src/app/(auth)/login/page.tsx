...
export default function LoginPage() {
 ...
 return (
 <div className="w-full max-w-[480px] bg-white rounded-3xl shadow-2xl shadow-emerald-500/5 p-10 border border-slate-200/50 mx-auto transition-all duration-500">
 <div className="mb-10 text-center sm:text-left">
 <h2 className="text-4xl font-black text-slate-900 tracking-tight uppercase">Login</h2>
 ...
 <input
 autoFocus
 className="w-full h-14 px-6 rounded-2xl border border-slate-200 bg-slate-50 text-slate-900 focus:ring-8 focus:ring-emerald-500/5 focus:border-emerald-500 outline-none transition-all placeholder:text-slate-400 font-bold"
 ...
 <input
 className="w-full h-14 px-6 pr-14 rounded-2xl border border-slate-200 bg-slate-50 text-slate-900 focus:ring-8 focus:ring-emerald-500/5 focus:border-emerald-500 outline-none transition-all placeholder:text-slate-400 font-bold"
 placeholder="••••••••"
 ...
 {error && (
 <div className="bg-rose-50 border border-rose-200 text-rose-600 p-4 rounded-2xl flex items-start gap-3 text-xs font-bold animate-in fade-in slide-in-from-top-2">
