...
export default function VerifyEmailPage() {
  ...
  if (checking) {
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-surface dark:bg-background-dark">
      ...
      <div className="bg-white w-full max-w-[480px] rounded-xl shadow-xl p-8 border border-primary/10 text-center animate-in zoom-in-95 duration-300">
        ...
        <div className="space-y-4">
          ...
          <button 
            ...
            className="w-full h-14 border-2 border-slate-200 text-slate-600 font-bold rounded-full hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center justify-center gap-2"
          >
