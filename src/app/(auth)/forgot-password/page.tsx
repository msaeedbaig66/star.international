    ...
    return (
      <div className="w-full max-w-[480px] bg-white rounded-2xl shadow-2xl shadow-primary/5 p-8 border border-primary/10 mx-auto animate-in fade-in slide-in-from-top-5 duration-500">
        ...
        <form onSubmit={handleUpdatePassword} className="space-y-6">
          <div className="flex flex-col gap-2">
            <label className="text-slate-900 dark:text-slate-100 text-[10px] font-black uppercase tracking-widest text-slate-500">New Password</label>
          ...
          <div className="flex flex-col gap-2">
            <label className="text-slate-900 dark:text-slate-100 text-[10px] font-black uppercase tracking-widest text-slate-500">Confirm Password</label>
            <input 
              required
              className={cn(
